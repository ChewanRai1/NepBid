    ...
    <>
      ...
      <nav className="hidden lg:flex fixed top-0 w-full bg-white h-16 shadow-md z-40 px-8">
        <div className="flex items-center justify-between w-full">
          ...
          {/* Center Menu */}
          <div className="flex items-center gap-8">
            <Link to="/auctions" className="flex items-center gap-2 text-lg hover:text-[#D6482b] transition-colors">
              <RiAuctionFill /> Auctions
            </Link>
            <Link to="/leaderboard" className="flex items-center gap-2 text-lg hover:text-[#D6482b] transition-colors">
              <MdLeaderboard /> Leaderboard
            </Link>
            
            {isAuthenticated && user?.role === "Auctioneer" && (
              <>
                <Link to="/submit-commission" className="flex items-center gap-2 text-lg hover:text-[#D6482b] transition-colors">
                  <FaFileInvoiceDollar /> Submit Commission
                </Link>
                <Link to="/create-auction" className="flex items-center gap-2 text-lg hover:text-[#D6482b] transition-colors">
                  <IoIosCreate /> Create Auction
                </Link>
                <Link to="/view-my-auctions" className="flex items-center gap-2 text-lg hover:text-[#D6482b] transition-colors">
                  <FaEye /> View My Auctions
                </Link>
              </>
            )}
            ...
            {isAuthenticated && (
              <Link to="/me" className="flex items-center gap-2 text-lg hover:text-[#D6482b] transition-colors">
                <FaUserCircle /> Profile
              </Link>
            )}
          </div>
          ...
          <div className="flex items-center gap-4">
            {!isAuthenticated ? (
              <>
                <Link to="/sign-up" className="bg-[#D6482B] px-6 py-2 rounded-full text-white hover:bg-[#b8381e] transition-colors">
                  Sign Up
                </Link>
                <Link to="/login" className="border-2 border-[#DECCBE] px-6 py-2 rounded-full text-[#D6482B] hover:bg-[#fffefd] hover:border-[#D6482B] transition-colors">
                  Login
                </Link>
              </>
            ) : (
              <button onClick={handleLogout} className="bg-[#D6482B] px-6 py-2 rounded-full text-white hover:bg-[#b8381e] transition-colors">
                Logout
              </button>
            )}
          </div>
      ...
      >
        <div className="relative">
          ...
          <ul className="flex flex-col gap-3">
            <li>
              <Link to="/auctions" className="flex items-center gap-2 text-lg hover:text-[#D6482b]" onClick={() => setShow(false)}>
                <RiAuctionFill /> Auctions
              </Link>
            </li>
            <li>
              <Link to="/leaderboard" className="flex items-center gap-2 text-lg hover:text-[#D6482b]" onClick={() => setShow(false)}>
                <MdLeaderboard /> Leaderboard
              </Link>
            </li>
            ...
            {isAuthenticated && user?.role === "Auctioneer" && (
              <>
                <li>
                  <Link to="/submit-commission" className="flex items-center gap-2 text-lg hover:text-[#D6482b]" onClick={() => setShow(false)}>
                    <FaFileInvoiceDollar /> Submit Commission
                  </Link>
                </li>
                <li>
                  <Link to="/create-auction" className="flex items-center gap-2 text-lg hover:text-[#D6482b]" onClick={() => setShow(false)}>
                    <IoIosCreate /> Create Auction
                  </Link>
                </li>
                <li>
                  <Link to="/view-my-auctions" className="flex items-center gap-2 text-lg hover:text-[#D6482b]" onClick={() => setShow(false)}>
                    <FaEye /> View My Auctions
                  </Link>
                </li>
              </>
            ...
            {isAuthenticated && (
              <li>
                <Link to="/me" className="flex items-center gap-2 text-lg hover:text-[#D6482b]" onClick={() => setShow(false)}>
                  <FaUserCircle /> Profile
                </Link>
              </li>
            )}
          ...
          {!isAuthenticated ? (
            <div className="my-4 flex gap-2">
              <Link to="/sign-up" className="bg-[#D6482B] font-semibold hover:bg-[#b8381e] text-xl py-1 px-4 rounded-md text-white" onClick={() => setShow(false)}>
                Sign Up
              </Link>
              <Link to="/login" className="text-[#DECCBE] bg-transparent border-[#DECCBE] border-2 hover:bg-[#fffefd] hover:text-[#fdba88] font-bold text-xl py-1 px-4 rounded-md" onClick={() => setShow(false)}>
                Login
              </Link>
            </div>
          ) : (
            <div className="my-4" onClick={() => { handleLogout(); setShow(false); }}>
